<?php
class M_view_progress extends CI_Model 
{
	...
	function get_data()
    {
    	$sql="SELECT * FROM credit_user LEFT JOIN credit_set_cabang ON credit_user.id_cabang = credit_set_cabang.id_cabang WHERE credit_user.level_user='Operator' ORDER BY credit_user.id_cabang ASC";
	...
	function get_data_omzet($id_user, $id_set)
    {
	...
	function get_data_kasbon($id_user, $id_set)
    {
	...
	//function menampilkan data
	function get_data_biaya_op($id_user, $id_set)
    {
	...
	//function menampilkan data omzet berdasarkan user
	function get_data_gaji($id_user, $id_set)
    {
	...
	function get_data_all($id_user, $id_set)
    {
